...
app.post('/api/send-inquiry', (req, res) => {
    ...
    console.log(` - emailClean bytes: ${emailClean}`);
	...
	// Read the HTML template once outside the map (more efficient)
        ...
        return; // ? exit here; response sent inside Promise.allSettled
    }
